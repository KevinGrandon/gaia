...
requireApp('rocketscreen/test/unit/mock_xmlhttprequest.js');
requireApp('rocketscreen/test/unit/mock_icon_retriever.js');
requireApp('rocketscreen/test/unit/mock_grid_components.js');
requireApp('rocketscreen/test/unit/mock_dock_manager.js');
requireApp('rocketscreen/test/unit/mock_grid_manager.js');
requireApp('rocketscreen/test/unit/mock_configurator.js');

require('/shared/js/screen_layout.js');

requireApp('rocketscreen/test/unit/mock_page.html.js');

requireApp('rocketscreen/js/page.js');
