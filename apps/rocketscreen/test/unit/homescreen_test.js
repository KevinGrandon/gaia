...
requireApp('rocketscreen/test/unit/mock_request.html.js');
requireApp('rocketscreen/test/unit/mock_lazy_loader.js');
...
requireApp('rocketscreen/js/message.js');
requireApp('rocketscreen/js/request.js');

requireApp('rocketscreen/js/homescreen.js');
