...
requireApp('rocketscreen/test/unit/mock_l10n.js');
requireApp('rocketscreen/test/unit/mock_page.js');
requireApp('rocketscreen/test/unit/mock_icon.js');
requireApp('rocketscreen/test/unit/mock_dock_manager.js');
requireApp('rocketscreen/test/unit/mock_home_state.js');
requireApp('rocketscreen/test/unit/mock_pagination_bar.js');
requireApp('rocketscreen/test/unit/mock_app.js');
requireApp('rocketscreen/test/unit/mock_apps_mgmt.js');
requireApp('rocketscreen/test/unit/mock_configurator.js');
requireApp('rocketscreen/test/unit/mock_hidden_apps.js');
requireApp('rocketscreen/test/unit/mock_icon_retriever.js');

require('/shared/js/screen_layout.js');
requireApp('rocketscreen/js/icon_manager.js');
requireApp('rocketscreen/js/grid_components.js');
requireApp('rocketscreen/js/grid.js');
