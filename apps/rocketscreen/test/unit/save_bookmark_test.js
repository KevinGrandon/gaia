...
requireApp('rocketscreen/test/unit/mock_mozsetmessagehandler.js');
requireApp('rocketscreen/test/unit/mock_bookmark_editor.js');
requireApp('rocketscreen/test/unit/mock_l10n.js');

requireApp('rocketscreen/js/components/status.js');
requireApp('rocketscreen/js/save-bookmark.js');
